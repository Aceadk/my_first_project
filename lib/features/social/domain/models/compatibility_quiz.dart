...
class QuizOption extends Equatable {
  ...
  Map<String, dynamic> toJson() {
    return {'id': id, 'text': text, 'emoji': emoji, 'value': value};
  }
...
class QuizResult extends Equatable {
  ...
  factory QuizResult.fromJson(Map<String, dynamic> json) {
    return QuizResult(
      ...
      user1Answers: (json['user1Answers'] as Map<String, dynamic>).map(
        (k, v) => MapEntry(k, v as String),
      ),
      user2Answers: (json['user2Answers'] as Map<String, dynamic>).map(
        (k, v) => MapEntry(k, v as String),
      ),
...
/// Types of insights.
enum InsightType { general, strength, growthArea, funFact, tip }

/// Score ratings.
enum ScoreRating { excellent, great, good, moderate, low, unknown }
...
class CompatibilityQuizzes {
  ...
  static List<CompatibilityQuiz> get all => [basicCompatibility, lifestyleQuiz];
}
