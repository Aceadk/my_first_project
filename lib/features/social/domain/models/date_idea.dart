  ...
  factory DateIdea.fromJson(Map<String, dynamic> json) {
    return DateIdea(
      ...
      requirements:
          ...
          [],
      bestFor:
          (json['bestFor'] as List<dynamic>?)
              ?.map(
                (e) => DateType.values.firstWhere(
                  (t) => t.name == e,
...
enum DateCostLevel { free, budget, moderate, expensive, splurge }
...
/// Types of dates.
enum DateType { firstDate, secondDate, established, special, virtual }
