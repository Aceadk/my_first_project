    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Core Features
          const _SectionHeader('Core Features', subtitle: 'Free for everyone'),
          ...
          // Premium Features
          const _SectionHeader('Premium Features', subtitle: 'Crush+ & Platinum'),
          const SizedBox(height: DsSpacing.md),
          Container(
          ...
          // Safety Features
          const _SectionHeader('Safety Features', subtitle: 'Your safety is our priority'),
          const SizedBox(height: DsSpacing.md),
          const _FeatureCard(
...
class _FeatureCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.only(bottom: compact ? DsSpacing.md : DsSpacing.lg),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
