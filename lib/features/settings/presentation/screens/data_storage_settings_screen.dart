...
class DataStorageSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<StorageSettingsCubit, StorageSettingsState>(
          ...
          return ListView(
            children: [
              ...
              SwitchListTile(
                ...
                onChanged: (enabled) => cubit.setMediaDownloadEnabled(enabled),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Slider(
                      ...
                      onChanged: (value) => cubit.setCacheSize(value.round()),
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
