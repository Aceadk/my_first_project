...
List<RouteBase> authRoutes() => [
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) => buildPage(state, const SplashScreen()),
  ),
  GoRoute(
    ...
    routes: [
      GoRoute(
        path: 'login',
        pageBuilder: (context, state) => buildPage(state, const LoginScreen()),
      ),
      GoRoute(
        path: 'signup',
        pageBuilder: (context, state) => buildPage(state, const SignUpScreen()),
      ),
      GoRoute(
        path: 'forgot',
        pageBuilder: (context, state) =>
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) => buildPage(state, const NewDeviceScreen()),
  ),
  GoRoute(
    path: CrushRoutes.basicInfo,
    pageBuilder: (context, state) => buildPage(state, const BasicInfoScreen()),
  ),
  GoRoute(
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) => buildPage(state, const LogoutScreen()),
  ),
];
