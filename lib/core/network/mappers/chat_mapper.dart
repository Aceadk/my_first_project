...
class ChatMapper {
  ...
  static domain.Message messageFromDto(
    dto.MessageDto messageDto, {
  ...
  static dto.MessageDto messageToDto(domain.Message message) {
    return dto.MessageDto(
      ...
      mediaUrl: message.type != domain.MessageType.text
          ? message.content
          : null,
  ...
  static dto.SendMessageRequestDto messageToSendRequest(
  ...
  static dto.SendMessageRequestDto textMessageRequest(
    String content, {
    String? replyToId,
  }) {
  ...
  static dto.SendMessageRequestDto imageMessageRequest(
    String mediaUrl, {
    String? thumbnailUrl,
  }) {
    return dto.SendMessageRequestDto.image(
      mediaUrl,
