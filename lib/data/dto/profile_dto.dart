...
class ProfileDto {
  ...
  factory ProfileDto.fromJson(Map<String, dynamic> json) {
    return ProfileDto(
      ...
      primaryPhotoIndex:
          json['primary_photo_index'] as int? ??
      ...
      relationshipGoals:
          json['relationship_goals'] as String? ??
      ...
      favoriteSongs: _parseStringList(
        json['favorite_songs'] ?? json['favoriteSongs'],
      ),
      favoriteSinger:
          json['favorite_singer'] as String? ??
          json['favoriteSinger'] as String?,
      isVerified:
          json['is_verified'] as bool? ?? json['isVerified'] as bool? ?? false,
      verificationBadge:
          json['verification_badge'] as String? ??
  ...
  static DiscoveryPreferences _parsePreferences(Map<String, dynamic>? json) {
    ...
    return DiscoveryPreferences(
      ...
      maxDistanceKm:
          (json['max_distance_km'] as num?)?.toDouble() ??
          (json['maxDistanceKm'] as num?)?.toDouble() ??
          50,
      showMeGenders: _parseStringList(
        json['show_me_genders'] ?? json['showMeGenders'],
      ),
      showMyDistance:
          json['show_my_distance'] as bool? ??
          json['showMyDistance'] as bool? ??
          true,
      showMyAge:
          json['show_my_age'] as bool? ?? json['showMyAge'] as bool? ?? true,
      hideFromDiscovery:
          json['hide_from_discovery'] as bool? ??
          json['hideFromDiscovery'] as bool? ??
          false,
      incognitoMode:
          json['incognito_mode'] as bool? ??
