...
class FirebaseProfileRepository implements ProfileRepository {
  ...
  CrushUser _fromDoc(DocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    if (profileData != null) {
      ...
      final dobRaw = profileData['dateOfBirth'];
      ...
      profile = Profile(
        ...
        // New profile fields
        heightCm: profileData['heightCm'] as int?,
        relationshipGoals: profileData['relationshipGoals'] as String?,
        languages: List<String>.from(profileData['languages'] ?? []),
        zodiacSign: profileData['zodiacSign'] as String?,
        educationLevel: profileData['educationLevel'] as String?,
        familyPlans: profileData['familyPlans'] as String?,
        personalityType: profileData['personalityType'] as String?,
        workout: profileData['workout'] as String?,
        socialMedia: profileData['socialMedia'] as String?,
        sleepingHabits: profileData['sleepingHabits'] as String?,
        smoking: profileData['smoking'],
        drinking: profileData['drinking'],
        diet: profileData['diet'],
        exercise: profileData['exercise'],
        pets: profileData['pets'] as String?,
        livingIn: profileData['livingIn'] as String?,
        favoriteSongs: List<String>.from(profileData['favoriteSongs'] ?? []),
        favoriteSinger: profileData['favoriteSinger'] as String?,
