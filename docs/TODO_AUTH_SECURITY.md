...
### [x] AUTH-SEC-002: Verify PKCE implementation for all OAuth providers
...
### [x] AUTH-SEC-003: Implement silent token refresh with request retry logic
...
### [x] AUTH-SEC-004: Audit rate limiting on all auth endpoints
...
### [x] AUTH-SEC-005: Verify account deletion completeness (GDPR compliance)
...
### [x] AUTH-SEC-006: Enforce iPad Layout Bounds on Auth Screens
