...
### [x] CHAT-UI-001: Implement responsive master-detail chat layout for iPad
...
### [x] CHAT-UI-002: Fix keyboard handling on iPad (external keyboard)
...
### [x] CHAT-UI-003: Implement proper media preview sizing
