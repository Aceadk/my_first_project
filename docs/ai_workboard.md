...
| --------------- | ---------- | ------------------------------------------ | ----------- | -------------------------------------------------------------------------------------------------- |
| T-2026-06-05-ALIGNMENT-P2-DOCS | 2026-06-05 | Web-Mobile Alignment — P2 #12 Docs/workflow drift | Completed | Added crush-web AGENTS.md (points to centralized workflow + rules); removed 3 stale duplicate trackers. Next: P2 #11 feature parity (calls/RTC, I18N) or operational Phase 2.5. |
