...
| --------------- | ---------- | ------------------------------------------ | ----------- | -------------------------------------------------------------------------------------------------- |
| T-2026-06-05-ALIGNMENT-PHASE-0 | 2026-06-05 | Web-Mobile Alignment — Phase 0 Stabilization | In Progress | Create Route/Deep-Link Matrix (P0), then Web Chat/Match Migration Plan (P0), then Web CI Upgrade (P1). |
